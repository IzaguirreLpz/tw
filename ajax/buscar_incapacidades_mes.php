...
?>
    ...
    $clinica_b="";
        ...
        <?php 
            ...
            if  (($fecha == $hoy)&& ($id_doctor==$user_id)){
            ...
            ?>
                    ...
                    <a href="edit_extendida.php?inca=<?php echo $id;?>"  class='btn btn-info' title='editar extendida' 
                       onclick="" ><i class="fa fa-edit"></i></a> 
                	
              <?php }else{ ?>
                    
                    
                    <a href="edit_incapacidad.php?inca=<?php echo $id;?>"  class='btn btn-info' title='editar refrendada' 
                       onclick="" ><i class="fa fa-edit"></i></a> 
	...
	window.open('reporte/re_incapacidades.php?desde='+desde);
}</script>
                </td>
              </tr>
          <?php
