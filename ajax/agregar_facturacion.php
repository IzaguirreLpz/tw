...
$id_rece= getMaxreceta()+1;
   // echo "<script>alert($id_rece) </script>";
    $insert_tmp=mysqli_query($mysqli, "INSERT INTO siec_medicamentos_entregados (ent_id_inventario,ent_id_atencion,ent_cantidad,ent_id_receta) VALUES('$id','$atencion','$cantidad','$id_rece')");
    
    
  //  $insert_ope=mysqli_query($mysqli, "INSERT INTO siec_pro_entradas(pro_id_inventario,pro_cantidad,operacion,id_empleado) VALUES ('$id','$cantidad','salida consulta','$user_id')");
