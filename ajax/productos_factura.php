<?php
	...
	require ("../funcs/conexion.php");//Contiene funcion que conecta a la base de datos
 ...
 //include pagination file
        ...
        $count_query   = mysqli_query($mysqli, "SELECT count(*) AS numrows FROM products WHERE cant >0 ");
