      ...
      <table class="table" id="tableListar">
        ...
        <tbody>
          <?php
			 ...
			 $sql = " SELECT emp_nombre,doc_clave_empleado,doc_id_doctor, cli_nombre,usu_username,doc_turno
 FROM siec_empleados,siec_doctores,siec_usuarios,siec_clinicas WHERE  
 doc_clave_empleado = emp_clave_empleado and doc_id_clinica = cli_id_clinica ";

			$query = mysqli_query($mysqli, $sql);
     
			
			$count_query   = mysqli_query($mysqli, "SELECT count(*) AS numrows FROM siec_doctores  ");
        ...
        while ($row=mysqli_fetch_array($query)){
                            ...
                            $id=$row['doc_id_doctor'];
			               $clave=$row['doc_clave_empleado'];
