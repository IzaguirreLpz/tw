      ...
      <table class="table" id="tableListar">
        ...
        <tbody>
          <?php
			 ...
			 $sql = "SELECT  lug_id_lugar, lug_id_region, lug_nombre, lug_direccion, lug_fecha, re_nombre FROM siec_lugar, siec_region WHERE 
re_id_region= lug_id_region;";
...
$id=$row['lug_id_lugar'];
			            $nombre=$row['lug_nombre'];
						$lugar=$row['lug_direccion'];
