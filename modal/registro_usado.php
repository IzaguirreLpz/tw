                ...
                <div class="col-sm-6">
                  <select  class="form-control"  name="codigo" id="codigo" data-placeholder="-- Seleccionar Medicamento --" onchange="tampil_obat(this)" autocomplete="off" required>
                    ...
                    ?>
               				    ...
               				    <input type=""class="" id="nom" name="nom" placeholder="" maxlength="80" onPaste="return false;" required autocomplete="off">
               				    <input type=""class="" id="mas" name="mas" placeholder="" maxlength="80" onPaste="return false;" required autocomplete="off">
