...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['editMode'])){
        ...
        precio_producto = $precio,precio_costo = $precioCompra, 
    ...
    VALUES('$codigo','$nombre',1,$precio,$precioCompra,0,1,'N/A','$categoria','N/A');";
                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        if ($edicion != 0) {
                            ...
                            echo "Agregar Nuevo Servicio ";
                        } ?>
                        <span class="tools pull-right">
                            <a class="fa fa-chevron-down" href="javascript:;"></a>

                            <a class="fa fa-share" href="servicios.php"></a>
                        </span>
                    </header>
                            ...
                            <?php 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        ?>
                                <div class="form-group">
                                    <label class="control-label col-lg-3">Nombre Servicio:</label>
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                   ...
                                   <!-- Text input-->
                                <div class="form-group">
                                    <label class="control-label col-lg-3">Precio Por Servicio:</label>
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fas fa-money-bill-wave"></i></span>
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="control-label col-lg-3">Costo Del Servicio:</label>
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fas fa-money-bill-wave"></i></span>
