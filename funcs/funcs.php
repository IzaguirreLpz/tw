...
function cambiaEstado($user_id)
{
	...
	$stmt = $mysqli->prepare("UPDATE tbl_usuario SET  estado_usuario = 'ACTIVO' WHERE id_usuario = ? ");
...
function grabarRES($id_usuario, $id_pregunta, $respuesta)
{
...
function enviarEmail($email, $nombre, $asunto, $cuerpo)
{
	...
	try {
		...
		$mail->Username = 'tecniwash504@gmail.com'; //Modificar
		$mail->Password = 'Bytheway_1'; //Modificar

		$mail->setFrom('tecniwash504@gmail.com', 'TECNIWASH'); //Modificar
